...
model.add(Conv2D(16, (5, 5), input_shape=(2988, 5312, 3), strides=(5, 5), activation='relu'))
...
model.compile(loss='categorical_crossentropy',
              ...
              metrics=['accuracy'])
Callback()
earlyStop = EarlyStopping(monitor='acc', min_delta=0, patience=15, verbose=2, mode='auto')
callbacks_list = [tbCallBack,earlyStop]
model.fit(trainData, trainLabels, batch_size=1, epochs=200, validation_data=(testData, testLabels), verbose=2, callbacks=callbacks_list)
